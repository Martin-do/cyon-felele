...
urlpatterns = [
    ...
    path('my-pledges/', views.my_pledges_view, name='my_pledges'),
    path('my-pledges/create/', views.create_self_pledge_view, name='create_self_pledge'),
    ...
    path('flyer/<slug:referral_slug>-<str:v>.png', views.public_flyer_view, name='public_flyer_versioned'),
    ...
    path('master/generate-token/', views.generate_admin_token_view, name='generate_admin_token'),
    path('master/pledges/record/', views.record_pledge_view, name='record_pledge'),
    path('master/pledges/<int:pk>/approve/', views.approve_pledge_view, name='approve_pledge'),
    path('master/pledges/<int:pk>/revoke/', views.revoke_pledge_view, name='revoke_pledge'),
