...
urlpatterns = [
    ...
    path('leaderboard/snapshot/', views.leaderboard_snapshot_view, name='leaderboard_snapshot'),
    ...
    path('master/flyers/<int:pk>/update/', views.admin_update_member_flyer_view, name='admin_update_member_flyer'),
